...
O problema do \textit{code retrieval} assemelha-se ao problema de \textit{question answering} em \acrshort{nlp}. Este problema consiste em dado uma questão e um conjunto de possíveis respostas, criar um modelo capaz de recuperar a resposta mais apropriada de acordo com a pergunta. Atualmente, a maioria dos modelos conseguem apenas responder satisfatoriamente a perguntas e respostas curtas. Um dos desafios da área é dado uma pergunta, um modelo ser capaz de responder com um artigo. Ou um modelo ser capaz de ler um livro e responder a perguntas \todo{achar referências}. O \textit{Google} publicou um desafio aberto, no qual a partir de uma questão, o modelo deve ser capaz de verificar se algum artigo do \textit{Wikipedia} contém a resposta. E o modelo deve ser capaz de extrair a resposta do artigo do \textit{Wikipedia} \citep{google-question-answering}.
