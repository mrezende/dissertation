...
Segundo \cite{Goodfellow-et-al-2016:representation-learning}, a forma como os dados são representados auxiliam no desempenho do algoritmo de aprendizagem de máquina. No caso do código-fonte, ao tratá-lo como texto, uma opção é representá-lo através de um vetor \textit{one-hot encoding}. 
