...
Segundo o artigo XXX, a maioria dos desenvolvedores recorrem ao Google para fazer busca de trechos de código-fonte. Porém o Google não provê uma busca especializada para código-fonte e trata o código-fonte como um texto de linguagem natural. Neste caso, ele não consegue extrair a semântica do código-fonte a menos que tenha comentá
E de acordo com XXX, os desenvolvedores acessam o triplo de páginas e gastam o triplo do tempo ao fazerem buscas relacionadas a trechos de código-fonte quando comparados com buscas não-relacionadas a código-fonte. Segundo o artigo, a maioria dos desenvolvedores ao deparar com um problema recorrem ao Google para fazer uma busca de trechos de código-fonte. Porém o Google trata código-fonte como um texto natural e não consegue extrair a semântica do código. 
