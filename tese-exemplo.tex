...
\chapter*{\begin{center} AGRADECIMENTOS \end{center}}
\thispagestyle{empty}
...
\renewcommand{\listfigurename}{\begin{center}Lista de ilustrações\end{center}}
\renewcommand{\listtablename}{\begin{center}Lista de tabelas\end{center}}
...
\cleardoublepage
  ...
  \let\ps@plain\ps@empty
  \pagestyle{empty}
  \printnoidxglossary[type=acronym,sort=word,nonumberlist,title={\begin{center}Lista de abreviaturas e siglas\end{center}}]
  \cleardoublepage
  \endgroup
