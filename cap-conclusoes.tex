...
\begin{itemize}
    ...
    \item Além disso, acreditamos que o desempenho relativamente inferior obtido pela arquitetura proposta por \cite{cambronero-deep-learning-code-search:2019} deve-se, principalmente, 
