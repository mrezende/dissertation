...
De acordo com \cite{Chen-bi-variational-autoencoder:2018}, a tarefa de recuperação de trecho de código-fonte consiste em:
...
A maior parte dos trabalhos atuais sobre recuperação de trecho de código-fonte passaram a utilizar aprendizagem de máquina com redes neurais artificiais. Tanto que \cite{cambronero-deep-learning-code-search:2019} cunharam o termo \textit{neural code search}, i.e., busca de código-fonte utilizando redes neurais artificiais. A principal abordagem utilizada nesses trabalhos é ensinar a rede neural a discriminar os trechos de código-fonte relevantes dos não relevantes a partir de uma intenção de busca. Para isso, as redes neurais aprendem a classificar os trechos de código-fonte relevantes com uma pontuação maior que os não-relevantes. Para realizar esta classificação, os trabalhos utilizam a técnica de agrupamento de vetores de representação distribuída ou \textit{joint embedding}.  
