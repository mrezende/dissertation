...
Os vetores contínuos das questões e trechos de código-fonte , o objetivo é treinar a rede neural a correlacionar o trecho de código-fonte à questão. Conforme citado anteriormente, uma abordagem comumente utilizada é o agrupamento de vetores contínuos ou \textit{joint embedding}, que mapeia os vetores das questões e trechos de código-fonte para um mesmo espaço vetorial. O intuito  E apróximá-los através de uma função objetivo, de tal maneira que as questões fiquem próximas dos trechos de código-fonte relevantes. 
