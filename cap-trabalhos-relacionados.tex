...
O vetor \textit{hidden} $\bm{h}$ é a parte mais importante do \acrshort{lstm}. Ele engloba através da célula de mémoria $C$ os resultados e cálculos prévios. Normalmente, ele é utilizado para representar os dados \citep{tom-young:trends-deep-learning-nlp}.
