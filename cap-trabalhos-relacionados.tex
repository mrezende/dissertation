...
O vetor contínuo de cada palavra pode ser combinado para gerar um vetor para a sentença inteira, e.g., podemos ter um vetor para o trecho de código-fonte, combinando os vetores de cada termo presente no código. Duas abordagens comumente utilizadas para combinar os vetores são \citep{cambronero-deep-learning-code-search:2019}:
...
A diferença básica entre as duas abordagens é a importância relativa dada a ordem das palavras na sentença. No caso do \textit{bag-of-words}, a ordem das palavras não é levada em consideração no momento de combinar os vetores. Por exemplo, dado o vetor abaixo:
