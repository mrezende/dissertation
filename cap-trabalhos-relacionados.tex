...
Diversos trabalhos foram feitos para a criação de uma busca semântica de trechos de código-fonte. Segundo \cite{yan-benchmark-code-search-information-retrieval-deep-learning:2020}, as duas estratégias comumente utilizadas são:

\begin{itemize}
    \item Fuzzy retrieval. Será??
\end{itemize}
