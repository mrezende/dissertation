...
Uma boa combinação dos vetores contínuos permite sintetizar as principais características da sentença em um vetor. Um dos objetivos da recuperação de trechos de código-fonte é a possibilidade de estabelecer relações semânticas também, onde trechos de código semanticamente similares sejam representadas por vetores similares. A partir deste rico espaço de similaridade, é possível ensinar a rede neural a correlacionar as questões aos trechos de código-fonte mais facilmente. Além disso, os vetores de representação podem ser reutilizados em outras tarefas como recomendação ou sumarização de trechos de código-fonte e identificação de linguagem de programação, por exemplo.
