...
Nas figuras abaixo, podemos ver que tanto bi-LSTM com CNN quanto o CNN apresentam uma diferença grande entre o erro de validação e o erro de treinamento. Um indicativo de \textit{overfitting}.
