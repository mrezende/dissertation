...
Análise do desempenho da rede neural & \textit{Overfitting} e extrapolação & Diminuir a diferença entre o erro de validação e o erro de treinamento dos modelos CNN & Análise através das curvas de erro de validação e treinamento vs época e capacidade do modelo & Em andamento \\
\hline
